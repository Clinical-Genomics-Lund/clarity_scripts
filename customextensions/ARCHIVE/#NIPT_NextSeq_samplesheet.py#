...
def main():
    ...
    for inputPool in inputPools :
        ...
        for sample in Samples :
            f_out.write(SampleDict[sample]['SampleLimsID'] + "_" + SampleDict[sample]['LibraryName'] + ",,,," + SampleDict[sample]['index7'] + "," + SampleDict[sample]['i7_seq'] + "," + SampleDict[sample]['index5'] + "," + SampleDict[sample]['rc_i5_seq'] + "," + "NIPT" + ",nipt_" + SampleDict[sample]['LibraryName'] + "\n")     
