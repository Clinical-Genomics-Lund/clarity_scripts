    ...
    for art in arts:
        ...
        for udf in elements:
            ...
            if temp == 'Diagnosis':
                ...
                if Diagnosis == 'AML' or Diagnosis == 'MDS' or Diagnosis == 'MPN' or Diagnosis == 'KLL' or Diagnosis == 'Annat' :
                    SampleDict[sampleLimsID].update({ 'Diagnosis' : Diagnosis })
                else :
                    api.reportScriptStatus( args[ "stepURI" ], "ERROR", "Sample Diagnosis must be either AML, MDS, MPN, KLL or 'Annat'")
