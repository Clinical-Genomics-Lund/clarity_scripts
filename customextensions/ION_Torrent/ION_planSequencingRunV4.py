...
def main():
    ...
    totalPoolVolume= FinalDNAPoolVolume + FinalRNAPoolVolume + FinalCFPoolVolume + FinalLiqBioPoolVolume + FinalCLPoolVolume
    ...
    if totalPoolVolume > 25 :
        f.write("\n###Use only 25 ul in subsequent steps###. \n")
