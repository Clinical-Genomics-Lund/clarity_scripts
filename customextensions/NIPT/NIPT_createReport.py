...
def main():
    ...
    os.system("ssh petter@mtlucmds1.lund.skane.se mkdir '/data/NIPT-rapporter/"+dir_date+"'" )
    ...
    for dom in output_artifacts.getElementsByTagName("art:artifact"):
        ...
        if html_fn != "NO_REPORT": 
            ...
            gen_fn = data["genesis_id"] + ".pdf"
            os.system("scp " + html_fn + " petter@mtlucmds1.lund.skane.se:/home/petter/niptreport/")
            
#            os.system("ssh petter@mtlucmds1.lund.skane.se '/home/petter/anaconda/bin/weasyprint /home/petter/niptreport/"+html_fn+" /home/petter/niptreport/"+LUID+".pdf && cp /home/petter/niptreport/"+LUID+".pdf /data/NIPT-rapporter && scp /home/petter/niptreport/"+LUID+".pdf glsai@mtapp046.lund.skane.se:/all'")


            os.system("ssh petter@mtlucmds1.lund.skane.se '/home/petter/anaconda/bin/weasyprint /home/petter/niptreport/"+html_fn+" /home/petter/niptreport/"+pdf_fn+" && cp /home/petter/niptreport/"+pdf_fn+" /data/NIPT-rapporter/"+dir_date+" && mv /data/NIPT-rapporter/"+dir_date+"/"+pdf_fn+" /data/NIPT-rapporter/"+dir_date+"/"+gen_fn+" && scp /home/petter/niptreport/"+pdf_fn+" glsai@"+HOSTNAME_BASE+":/all'")
 
#            os.system("cp /home/petter/niptreport/"+LUID+".pdf /data/NIPT-rapporter")
