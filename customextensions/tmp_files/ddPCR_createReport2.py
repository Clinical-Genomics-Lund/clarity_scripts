...
def get_data(dom):
    ...
    sample_data["C_mut"] = (2.0 * sample_data["Lambda_mut"] * 20.0 *  sample_data["cfDNA_Total_elution_vol_ul"] ) / ( 0.00085 * sample_data["IBSAFE_Input_per_well_vol_ul"] * sample_data["Total_plasma_extracted_vol_mL"] )

    sample_data["C_wt"] = (2.0 * sample_data["Lambda_wt"] * 20.0 *  sample_data["cfDNA_Total_elution_vol_ul"] ) / ( 0.00085 * sample_data["IBSAFE_Input_per_well_vol_ul"] * sample_data["Total_pla\
