...
def complete_file( artifactluid_offile ):    ### finds the file LUID from artifact LUID of the file
    ...
    fileGET = requests.get(file_URI, auth=(args[ "username" ],args[ "password" ])) ##retrieves the file
...
def main():
    ...
    complete_file( args[ "artifactLUID" ] )
