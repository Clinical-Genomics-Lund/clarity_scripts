			...
			try:
				if len(row) == 4 and row[0] != 'well':
					if row[0] != "" :
						...
						if well == "B1" and row[1] == 1:
							st1 = conc
						else:
							st1 = "0"

						if well == "H1" and row[1] == 1:
							st2 = conc
						else:
							st2 = "0"
...
def main():
	...
	if selected_container[0].type.name == "96 well plate" or selected_container[0].type.name == "QuantIT 96 well plate":
