...
availableStages = { #"NexteraQAML" : "" ,
                    ...
                    #"TWIST": "",
                    #"NIPT": "",
                    #"SarsIDPT" : "https://mtapp046.lund.skane.se/api/v2/configuration/workflows/860/stages/3731",
                    "MicrobiologyIDPT" : "https://mtapp046.lund.skane.se/api/v2/configuration/workflows/861/stages/3744",
                    "MicrobiologyIDPT-CTG" : "https://mtapp046.lund.skane.se/api/v2/configuration/workflows/861/stages/3744",
                    }
#####################################################################################
...
def getTWISTLibraries( containerID) :
    containerURI = "https://clarity-test.lund.skane.se/api/v2/containers/" + containerID
    ...
    ppPoolURI = "https://clarity-test.lund.skane.se/api/v2/steps/" + ppURI.split("/")[-1] + "/pools"
