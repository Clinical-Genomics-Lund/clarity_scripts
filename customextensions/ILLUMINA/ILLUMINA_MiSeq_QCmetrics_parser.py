...
def main():
    ...
    if (found_directory == "" ) :
        print "Could not find a MiSeq run with the provided reagent cartridge ID. Can not import run data. Run not finished yet?"
        sys.exit(255)

    #Get the html file to parse
    flowcell = found_directory.split("_")[-1]
